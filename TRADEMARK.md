...
## You may
- Fork, modify, and deploy the code for any purpose the license allows.
- State, factually, that your project is "built on Vigil" or "based on
...
If you deploy a fork for your region, **rebrand it.** Keep the code open;
use your own name. Questions: vigil@youthewave.org.
