...
export async function GET(request: NextRequest) {
  ...
  const parsed = querySchema.safeParse({ q: rawQ || undefined, estado: rawEstado || undefined })
  if (!parsed.success || (!parsed.data.q && !parsed.data.estado)) {
