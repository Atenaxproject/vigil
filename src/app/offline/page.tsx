...
export default async function OfflinePage() {
  ...
  return (
    <main className="mx-auto flex min-h-[50vh] max-w-md flex-col items-center justify-center px-4 py-12 text-center">
      ...
      <p className="mt-4 text-[16px] leading-relaxed text-slate-600">{t('message')}</p>
      <Link
        href="/"
        className="mt-8 min-h-[44px] rounded-input bg-vigil-blue px-6 py-2.5 text-[16px] font-medium text-white"
      >
        {t('retry')}
      </Link>
    </main>
