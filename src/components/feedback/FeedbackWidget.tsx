    ...
    <>
      {createPortal(
        <button
          ...
          className="fixed bottom-[calc(5rem+env(safe-area-inset-bottom))] right-4 z-40 flex h-11 w-11 min-h-[44px] min-w-[44px] items-center justify-center rounded-full border border-slate-200 bg-white text-vigil-blue shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-vigil-blue/40 lg:bottom-6"
          aria-label={t('open')}
        >
